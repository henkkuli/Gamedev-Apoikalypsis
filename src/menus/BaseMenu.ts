...
class BaseMenu implements renderer.RenderLayer {
    constructor(private _components: BaseMenu.Component[], private _selected: BaseMenu.Component) { }

    get components(): BaseMenu.Component[] {
        return this._components;
    }
    set components(components: BaseMenu.Component[]) {
        this._components = components;
    }
    get selected(): BaseMenu.Component {
        return this._selected;
    }
    set selected(selected: BaseMenu.Component) {
